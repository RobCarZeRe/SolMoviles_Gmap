...
public class RutaMapa extends AsyncTask<Void,Integer,Boolean> {
    ...
    protected Boolean doInBackground(Void... voids) {
        try{
            final StringBuilder url = new StringBuilder("https://maps.googleapis.com/maps/api/directions/xml?origin="+editDesde+"&destination=-18.005672,-70.225465&key=AIzaSyC-YYWOC3Kf7ALLdp9PnD3Vh3aIZ63KxSg");
